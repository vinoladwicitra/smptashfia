...
siteSettings.patch(
  ...
  zValidator('json', z.object({
    ...
    maps_embed_url: z.string().optional().refine(v => v === undefined || (v.startsWith('https://') && (() => { try { new URL(v); return true; } catch { return false; } })()), { message: 'maps_embed_url must be a valid HTTPS URL' }),
