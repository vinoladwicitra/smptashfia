...
import { IconLogout, IconUser, IconBook, IconCalendar, IconClock } from '@tabler/icons-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        <h1 className="text-2xl font-bold text-text mb-6">Dashboard Guru</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-xl p-5 shadow-sm border border-border">
            ...
            <p className="text-sm text-text-light">Total Kelas</p>
          </div>
          <div className="bg-white rounded-xl p-5 shadow-sm border border-border">
            <div className="flex items-center gap-3 mb-3">
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-border text-center">
          ...
          <p className="text-text-light text-sm">Fitur dashboard guru akan segera tersedia.</p>
        </div>
      </main>
    </div>
  );
